                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                ...
                                                                Se actualizo la información de tu pedido
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                              ...
                                                              <tr>
                                                                  <td valign="top" class="dataTableContent" mc:edit="data_table_content00">
                                                                     <div mc:edit="std_content01">
                                                                     	Si hay datos incorrecto comuncate a
                                                                     	<a href="mailto:bad.leal@gmail.com">
                                                                     		bad.leal@gmail.com
                                                                     	</a>
                                                                     </div>
                                                                  </td>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a href="{{ url('/compras/' . $order->shoppingCartId() )}}" target="_blank">Ver más información de tu pedido</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
